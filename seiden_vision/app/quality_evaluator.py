...
def evaluate_quality(result: dict[str, Any], *, min_brightness: float, min_sharpness: float) -> dict[str, Any]:
    """Evaluate provider-independent technical image quality."""
    ...
    # Compatibility for 0.3.x dashboards. This alias will be removed in a future major version.
    enriched["operational"] = dict(enriched["quality_evaluation"])
    return enriched
